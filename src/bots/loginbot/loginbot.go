...
func NewBot(dbService *database.Service, botId int, token string) (err error) {
	...
	b.Handle("/start", func(c tele.Context) (err error) {
		...
		c.Send(userName+"! 🏴‍☠️ AndyDrozhzhin! Добро пожаловать на борт!\n\n"+
			"Для тебя — любое кино и сериалы без ограничений!\n"+
			"🎬 Смотри в любом формате и месте — Пиратка добудет всё!\n\n"+
			"В этом боте я сообщу тебе о всех новинках сериалов и анонсах, которые ты поместил в ⭐️ Избранное.\n\n"+
			"На моем корабле ты найдешь:\n\n"+
			"🧱 Трюм — канал с самой свежей добычей. Все последние новинки — здесь!\n"+
			"📺 База в Телеграм — смотри кино прямо в Телеграме. Удобно и без рекламы!\n"+
			"🏝️ Тортуга — наш сайт. Главная база, где тусуются все настоящие Пираты.", menu)
		err = c.Send("А сейчас вот твоя доля в добыче —\n"+
			"🔥 5 самых горячих новинок в отличном качестве:", inline)
